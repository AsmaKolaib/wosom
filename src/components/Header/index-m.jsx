  ...
  return (
    <section className="relative px-4 py-3 h-screen w-full">
      <nav className="fixed flex w-full justify-between z-50  py-2 font-main font-bold text-sm ">
        ...
        <div className=" z-10 flex items-center pr-7">
          {/* <span className=" "> */}
          <NavLink
            to="https://wosom.ai/login"
            className="font-main font-bold hover:opacity-90 bg-white rounded-[8px]  px-8 py-[10px] mr-2"
          >
            Sing up
          </NavLink>
          {/* </span> */}
          <span className=" ">
            <button
              className=" flex justify-between items-center  bg-white rounded-[8px] px-5 py-1"
              onClick={handleNav}
            >
              {nav ? "Close   " : "Menu"}
              <svg
                ...
                viewBox="0 0 41 41"
                fill="none"
                className={`ml-2 transition-transform duration-75 ${
                  nav ? "transform rotate-45" : ""
                }`}
              >
        ...
        <div
          className={` pt-[66px] w-[247px] h-fit bg-[#adadad] rounded-lg p-2 absolute pb-3  right-[21px] transition ease-in duration-[1s]	
